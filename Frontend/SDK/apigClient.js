...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://3vdyp6r3lg.execute-api.us-east-1.amazonaws.com/v2';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'filename', 'labels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'filename', 'labels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
